...
量价标记是根据历史条件频率筛选出的**收盘后观察提示**，不等同于买点、卖点或收益承诺。原有六类在日 K、周 K、月 K 展示各周期独立证据；全市场新增的 `低位破低反包`、金针观察/确认和 `高位巨量长上影`只有日线证据，因此不外推到周/月 K。tooltip 会显示方向频率、样本数、同场景对照（可用时）和截止日。触发定义见[量价观察标记产品决策](docs/kline-turning-marker-product-decision-2026-08-22.md)，全市场结果见[日 K 全市场变盘点研究](docs/full-market-turning-point-study-2026-08-22.md)，完整研究索引见[设计文档](docs/README.md)。
