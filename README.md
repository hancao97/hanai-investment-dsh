...
量价标记是根据历史条件频率筛选出的**收盘后观察提示**，不等同于买点、卖点或收益承诺。日 K tooltip 会给出已验证日线样本中未来观察窗口的上涨/走弱频率、样本数和截止日；周 K、月 K 只迁移形态规则，不外推日线概率。触发定义、样本边界和未进入产品的候选条件见[量价观察标记产品决策](docs/kline-turning-marker-product-decision-2026-08-22.md)，完整研究索引见[设计文档](docs/README.md)。
