...
量价标记是根据历史条件频率筛选出的**收盘后观察提示**，不展示胜率，不等同于买点、卖点或收益承诺。触发定义、样本边界和未进入产品的候选条件见[量价观察标记产品决策](docs/kline-turning-marker-product-decision-2026-08-22.md)，完整研究索引见[设计文档](docs/README.md)。
